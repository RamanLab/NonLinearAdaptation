%% Simulation study for sufficient condition for Global adaptation with negative feedback with buffer (Fig 6 of the manuscript). Run MUL_NFB_NON_LIN SIMULINK model file before.
